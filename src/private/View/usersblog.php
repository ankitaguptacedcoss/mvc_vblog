...
<body>
  ...
  <?php
  //finding blog from blogs table of particular user
  $Blog = Blog::find('all', array('user_id' => $_SESSION['user_id']));
  echo '<div class="row row1">';
  //displaying  own blog to user
  foreach ($Blog as $v) {
    echo '<div class="card  my-4 col-4 mx-5 ">';
