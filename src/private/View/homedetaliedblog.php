...
<body>
    <?php
    //finding data using blogid for single blog display on home page
    ...
    echo "<a class='card-text  fs-6' href='../View/showblogs.php?blogid=$v->blog_id'><button class='btn btn-primary'>Back</button></a><br><br>";
    echo "<div class='row'>";
    ...
    echo "<p class='card-text fst-italic fs-6'> Posted on :" . $Blog->post_date . "</p>";
